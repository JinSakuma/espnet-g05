...
class ContextualBlockConformerEncoder(AbsEncoder):
    ...
    def forward_train(
        ...
        ys_chunk2, mask_online2, _, _, _, _, _ = self.encoders(
        ...
        if self.normalize_before:
            ...
            ys_pad2 = self.after_norm(ys_pad2)
    ...
    def forward_infer(
        ...
        if prev_states is None:
            ...
            #logging.info("initialize prev_states")
        else:
        ...
        if prev_states is not None:
            ...
            ilens += ilens_buffer
            #logging.info("extend from prev_states")
        ...
        if is_final:
            ...
            # logging.info(overlap_size)
            # logging.info(block_num)
            # logging.info(res_frame_num)
            # logging.info(xs_pad.shape)
